...
let total = <c:out value="${total}" default="0" />;

// ChartDataLabels 플러그인 명시적으로 등록
...
$(document).ready(function(){
	...
	$('#searchBtn').on('click', function() {
		...
		let data = {
		    ...
		    startMonth: startMonth || '202401',  // 기본값 1월
		    endMonth: endMonth || '202412',      // 기본값 12월
		    selectedYear: $("#selectedYear").val() || new Date().getFullYear(),
		    bzentNo: bzentNo,
		    period: period
		};
	    ...
	    console.log("Selected Year: ", $("#selectedYear").val());
	...
	$("#resetBtn").on("click", function(){
		// 초기화 시 전체 매출 금액 가져오기
	    updateTotalSalesAmount({ bzentNo: bzentNo });
		location.reload();
	});
...
<div class="wrap">
	...
	<!-- 합계 매출액(원) -->
	<div class="amt-cont w-350">
		<div class="amt-top">
			<div class="amt-title-sub">
				<div class="amt-title">합계 매출액(원)</div>
			</div>
			<div class="amt-title-main">
				<span class="title-bge total">total</span>
				<div class="amt-total" id="clclnTotal">
					${totalSalesAmount}
				</div>
			</div> 
		</div>
		...
		<div class="cont search-summary">
			<div class="search-wrap">
				...
				<div class="search-cont startSummary">
					<p class="search-title">시작 년/월<span class="summary" id="dateSummary"></span></p>
				</div>
				<div class="divide-border startSummary"></div>
				<!-- 끝 년월 기간 검색조건 -->
				<div class="search-cont endSummary">
					<p class="search-title">끝 년/월<span class="summary" id="dateSummary"></span></p>
				</div>
			...
			<div class="tap-btn-wrap">
				<div class="tap-wrap">
					<div data-type=''  class="tap-cont active">
						...
						<span class="bge bge-default" id="clclnTotal">${allSales}</span>
					</div>
				</div>
			</div>
			<!-- /tap-btn-wrap -->
