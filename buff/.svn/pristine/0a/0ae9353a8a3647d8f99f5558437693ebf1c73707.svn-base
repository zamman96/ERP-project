...
<!-- 			<button class="btn btn-default" style="height: 44px;" id="searchBtn">검색 <span class="icon material-symbols-outlined">search</span></button> -->
      </div>
		<!-- 검색 조건 끝 -->
		<div class="cont">
		<!-- 테이블 분류 시작 -->
		...
		<table class="table-default">
					<thead>
						<tr>
							...
							<th class="center sort sort-gds" data-sort="gdsType" style="width: 30%;">
								유형
								<div class="sort-icon">
									<div class="sort-arrow">
