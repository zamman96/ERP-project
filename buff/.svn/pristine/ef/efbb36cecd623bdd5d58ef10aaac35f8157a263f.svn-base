...
* @fileName     : HdofcMenuService.java
* @author       : 송예진
* @date         : 2024.10.01
* @description  : 판매 메뉴 조회
* ===========================================================
* DATE              AUTHOR             NOTE
* -----------------------------------------------------------
* 2024.10.01        송예진     	  			최초 생성
*/
public interface HdofcMenuService {
	/**
	...
	* @return      : 세트 메뉴 수정
	*/
	public int editSetMenu(MenuVO menuVO, List<MenuSetVO> menuSetVO, MultipartFile file);
	...
	* @return      : 세트메뉴 등록
	*/
	public String registSetMenu(MenuVO menuVO, List<MenuSetVO> menuSetVO, MultipartFile file);
