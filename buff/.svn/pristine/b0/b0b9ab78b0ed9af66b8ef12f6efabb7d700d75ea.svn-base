<%--
 	@fileName    : selectStockAjmt.jsp
 	@programName : 재고조정 현황 페이지
 	@description : 재고조정으로 인한 재고 현황을 보여주는 페이지
 	@author      : 송예진
 	@date        : 2024. 10. 14
--%>
	...
	<div class="search-section">
		...
		<div class="cont search-original">
			<div class="search-wrap">
				...
				<!-- 대유형 검색조건 -->
				<div class="search-cont" hidden>
					<p class="search-title">상품대유형</p>
					<div class="select-custom w-100">
			...
			<!-- 테이블 분류 시작 -->
				<div class="tap-btn-wrap">
					<div class="tap-wrap">
						...
						<div data-type='AJMT01' class="tap-cont">
					...
					<div class="btn-wrap">
						<button class="btn-active" onclick="location.href='/cnpt/stock/insertStockQty'">등록 <span class="icon material-symbols-outlined">East</span></button>
					</div>
				</div>
			<!-- 테이블 분류 끝 -->
