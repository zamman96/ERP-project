...
// 		let deliType = $('#deliType option:selected').text();
	...
	$(document).on('click','.dealDtl',function(){
		...
		location.href='/hdofc/deal/dtl?poNo='+poNo+'&type='+type;
	})
	...
	<div class="search-section">
		...
		<div class="cont search-original">
			<div class="search-wrap">
				...
				<div class="search-cont">
					<p class="search-title bzentNm">거래처명</p>
		...
		<div class="cont search-summary">
			<div class="search-wrap">
				...
				<!-- 검색조건 -->
				<div class="search-cont">
					<p class="search-title bzentNm">거래처명 <span class="summary" id="bzSummary">전체</span></p>
				</div>
				<div class="divide-border"></div>
				<!-- 검색조건 -->
				<div class="search-cont">
				...
				<table class="table-default">
					<thead>
						<tr>
							...
							<th class="center sort sort-gds" data-sort="bzentNm" style="width: 20%;">
							<c:if test="${type=='po'}">거래처명</c:if><c:if test="${type=='so'}">가맹점명</c:if>
							<div class="sort-icon">
								<div class="sort-arrow">
								  <span class="sort-asc">▲</span>
							...
							<th class="center sort sort-gds" data-sort="clclnAmt" style="width: 15%;">총액(원)
							<div class="sort-icon">
								<div class="sort-arrow">
								  <span class="sort-asc">▲</span>
								  <span class="sort-desc">▼</span>
