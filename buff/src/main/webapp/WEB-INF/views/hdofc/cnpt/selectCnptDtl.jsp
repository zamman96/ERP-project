...
$(function(){
	...
	$('#autoInput').on('click', function(){
		$('#bzentNm').val('대덕')
		$('#bzentType').val('BZ_C01');
		$('#bzentType').siblings('.select-selected').text('식품');
		$('#bzentTelno1').val('02')
		$('#bzentTelno2').val('784')
		$('#bzentTelno3').val('1568')
		$('#bzentZip').val('01803')
		$('#bzentAddr').val('서울 노원구 공릉로 104-9');
	})
})
  ...
  <div class="container-fluid">
    <div class="row mb-2 justify-content-between">
      	<div class="row align-items-center">
	        ...
	        <h1 class="m-0 cnpt-insert" id="autoInput">거래처 등록</h1>
      	</div>
    	<div class="btn-wrap">
	...
	<div class="cont">
		...
		<div class="table-wrap">
			...
			<table class="table-blue">
				<tr>
					<th style="width: 15%;">거래처명  <span class="es cnpt-insert">*</span></th>
					<td style="width: 35%;"><input id="bzentNm" type="text" class="text-input"></td>
					<th style="width: 15%;">유형  <span class="es cnpt-insert">*</span></th>
