...
$(function(){
	...
	$('#updateClcln').on('click', function(){
		...
		let htmlStr = "<p>등록된 계좌정보인 "+bankTypeNm+"은행의 "+actno+"에서 정산의 총 합계만큼 정산처리하시겠습니까?</p><p>정산처리가 될 경우 <span class='es'>환불이 불가능</span>합니다.</p>";
  ...
  <div class="container-fluid">
    <div class="row mb-2 justify-content-between">
      	<div class="row align-items-center">
	      	<button type="button" class="btn btn-default mr-3" onclick="location.href='/hdofc/deal/list?type=${type}'"><span class="icon material-symbols-outlined">keyboard_backspace</span> 목록으로</button>
...
<div class="wrap">
	...
	<!-- cont 끝 -->
		...
		<div class="cont">
			...
			<div class="table-wrap">
				<div class="table-title">
						<div class="cont-title type-po"><span class="material-symbols-outlined title-icon">payments</span>거래처 정보</div> <!-- 타입에따라 제목 변경 -->
						<div class="cont-title type-so"><span class="material-symbols-outlined title-icon">store</span>가맹점 정보</div> <!-- 타입에따라 제목 변경 -->
				</div>
				<table class="table-blue">
					<tr>
						<th class="type-po" style="width:15%;">거래처명</th>
						<th class="type-so" style="width:15%;">가맹점명</th>
