...
let bzentVO = "${bzentVO}";
console.log("bzentVO : ", bzentVO);
let bankVO = "${bankVO}";
console.log("bankVO : ", bankVO);
...
$(function(){
	...
	// 모달 취소버튼 클릭-> 일반모드 전환
	$(".modal-close, #btnCancel").on("click", function(){
...
<div class="wrap">
	...
	<div class="cont">
		...
		<div class="table-wrap" style="overflow-x: inherit;">
			<div class="table-title">
					<div class="cont-title"><span class="material-symbols-outlined title-icon">payments</span>거래처 정보</div>
			</div>
				...
				<tr>
					...
					<td>
						<input type="text" id="bzentNm" 
							   name="bzentNm" value="${bzentVO.bzentNm}" disabled readonly />
					</td>
					<td>
					...
					<td colspan="3">
						<div class="tel-wrap">
							<input id="bzentTelno1" name="bzentTelno1"
								   value="<%= telParts[0] %>" disabled type="text" class="input-tel">-
							<input id="bzentTelno2" name="bzentTelno2"
								   value="<%= telParts[1] %>" disabled type="text" class="input-tel">-
							<input id="bzentTelno3" name="bzentTelno3"
								   value="<%= telParts[2] %>" disabled type="text" class="input-tel">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<div class="addr-zip-wrap">
							<div class="addr-wrap">
								<input class="input-zip" id="bzentZip" name="bzentZip"
									   value="${bzentVO.bzentZip}"disabled type="text"/>
								<button class="btn-default btn-click" type="button" id="btnPost1" disabled>우편번호 검색</button>
							</div>
							<div class="addr-wrap">
								<input class="input-addr" id="bzentAddr" name="bzentAddr"
									   value="${bzentVO.bzentAddr}" disabled type="text"/>
								<input class="input-addr" id="bzentDaddr" name="bzentDaddr"
				...
				<tr>
					...
					<td>
						<div class="select-custom">
							<select class="select-bank" name="bzentBankType" id="bzentBankType" disabled>
								<!-- 미선택 기본 옵션 -->
	...
	<div class="cont">
		...
		<div class="table-wrap">
			<div class="table-title">
					<div class="cont-title"><span class="material-symbols-outlined title-icon">manage_accounts</span>거래처 담당자 정보</div>
			</div>
			<table class="table-blue">
				<tr>
					<th>담당자 명</th>
					<td>
						<input type="text" id="mbrNm" name="mbrNm"
							   value="${bzentVO.mbrVO.mbrNm}" disabled readonly />
					</td>
				</tr>
				<!-- 비밀번호 추가 시작 -->
				...
				<!-- 비밀번호 추가 끝 -->
				<tr>
					<c:set var="phoneNumber2" value="${bzentVO.mbrVO.mbrTelno}" />
					<%
						...
						<div class="addr-zip-wrap">
							<div class="addr-wrap">
								<input class="input-zip" id="mbrZip" name="mbrZip"
									   value="${bzentVO.mbrVO.mbrZip}" disabled type="text"/>
							...
							<div class="addr-wrap">
								<input class="input-addr" id="mbrAddr" name="mbrAddr"
									   value="${bzentVO.mbrVO.mbrAddr}" disabled type="text"/>
								<input class="input-addr" id="mbrDaddr" name="mbrDaddr"
									   value="${bzentVO.mbrVO.mbrDaddr}" disabled type="text"/>
							</div>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" class="text-input" 
							   ...
							   value="${bzentVO.mbrVO.mbrEmlAddr}" disabled />
					</td>
				</tr>
			</table>
		<!-- table-wrap 끝 -->	
